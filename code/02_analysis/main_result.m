...
run ../01_build/ShowMasterParameters.m
...
load ../01_build/WageSci/WageScientistData
% load ../01_build/WageSci/WageScientistDataCR
...
writetable(df, 'df.xlsx', 'WriteMode', 'replace');
